...
class Fnouvelavion extends Zend_Form {
  ...
  public function init() {
    //===============Parametre du formulaire
       $this->setName ( 'nouvelpersonne' );
       $this->setMethod('post');
       $this->setAction('');
       $this->setAttrib('id', 'Fnouvelpersonne');
    ...
    $eAvion = new Zend_Form_Element_Text('nouveauPersonne');
    $eAvion ->setLabel('Personne :')
        ->setRequired(true)
    ...
    $eSubmit  ->setLabel('Ajouter')
          ->setAttrib('class', 'button_personne')
